...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('talks_talk', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Talk.notes_html'
        db.add_column('talks_talk', 'notes_html',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('talks_talk', 'notes')

        # Deleting field 'Talk.notes_html'
        db.delete_column('talks_talk', 'notes_html')
    ...
    models = {
        ...
        'talks.talk': {
            'Meta': {'object_name': 'Talk', 'unique_together': "(('talk_list', 'name'),)", 'ordering': "('when', 'room')"},
            ...
            'talk_list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'talks'", 'to': "orm['talks.TalkList']"}),
