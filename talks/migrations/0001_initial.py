...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('talks_talklist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lists', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(blank=True, max_length=255)),
        ))
        db.send_create_signal('talks', ['TalkList'])

        # Adding unique constraint on 'TalkList', fields ['user', 'name']
        db.create_unique('talks_talklist', ['user_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'TalkList', fields ['user', 'name']
        db.delete_unique('talks_talklist', ['user_id', 'name'])

        # Deleting model 'TalkList'
        db.delete_table('talks_talklist')
